...
class _AboutScreenState extends State<AboutScreen> {
  ...
  static const _github  = 'github.com/gitubpatrice/PDF-TECH';
      ...
      body: ListView(
        ...
        children: [
          ...
          _HelpCard(
            title: 'Ouvrir un PDF',
            steps: [
              'Bouton "Ouvrir un PDF" en bas de l\'accueil',
              'Ou appuie sur un fichier récent / favori',
              'Google Drive : onglet Cloud → Google Drive',
            ],
          ),
          _HelpCard(
            title: 'Utiliser un outil',
            steps: [
              'Onglet "Outils" → choisis l\'outil',
              'Ou depuis l\'accueil → "Actions rapides"',
            ],
          ),
          _HelpCard(
            title: 'Mise à jour',
