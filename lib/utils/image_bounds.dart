...
/// Garde-fou anti "image-bomb" : décodeur PNG/JPEG/GIF qui inspecte
/// UNIQUEMENT les en-têtes pour rejeter des dimensions absurdes (PNG IHDR
/// affirmant 50000×50000 → 10 Go heap au decode).
///
/// N'effectue aucun décodage pixel. Retourne `null` si dimensions
/// raisonnables ou si format non reconnu (laisse passer — d'autres caps
/// en aval).
///
/// F5 v1.12.2 — comble l'absence de probe dimensions révélée par l'audit.
/// Aligné sur le pattern Read Files Tech `lib/utils/image_bounds.dart`.
