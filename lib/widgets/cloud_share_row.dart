...
/// Utilise le MethodChannel `com.pdftech.pdf_tech/share` (sendToPackage)
/// qui passe par FileProvider + setPackage côté Kotlin.
///
/// Sécurité : aucune URI directe — uniquement content:// URIs avec
/// FLAG_GRANT_READ_URI_PERMISSION limité à l'app cible.
class CloudShareRow extends StatelessWidget {
  ...
  static const _channel = MethodChannel('com.pdftech.pdf_tech/share');
